...
class InputForm(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.nb_habitat = QtWidgets.QSpinBox()
        self.nb_habitat.setRange(0, 2147483647)
        self.nb_habitat.setValue(0)
        self.habitat_layout.addWidget(QtWidgets.QLabel("Nombre d'habitant :"))
        self.habitat_layout.addWidget(self.nb_habitat)
    ...
    def get_input_data(self):
        return {
            "nb_habitat": self.nb_habitat.value(),
